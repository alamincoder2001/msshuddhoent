...
class Assets extends CI_Controller
{
    ...
    public function getPoCharge()
    {
        ...
        $poCharge = $this->db->query("SELECT SaleMaster_InvoiceNo,SaleMaster_SaleDate, po_charge from tbl_salesmaster
                WHERE Status = 'a'
                and SaleMaster_branchid = " . $this->session->userdata('BRANCHid') . "
                $clauses
                ")->result();

        echo json_encode($poCharge);
    }
