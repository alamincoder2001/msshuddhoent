...
class Sales extends CI_Controller
{
    ...
    public function addSales()
    {
        ...
        try {
            ...
            $sales = array(
                ...
                'po_charge' => $data->sales->po_charge,
                'vehicle_no' => $data->sales->vehicle_no,
                'Status' => 'a',
    ...
    public function getSalesRecord()
    {
        ...
        if (isset($data->vehicleNo) && $data->vehicleNo != '') {
            $clauses .= " and sm.vehicle_no = '$data->vehicleNo'";
        }
...
<?php
    ...
    {
        $vehicles = $this->db->query("SELECT SaleMaster_SlNo,SaleMaster_InvoiceNo,vehicle_no
         FROM tbl_salesmaster WHERE Status = 'a' and SaleMaster_branchid = ?", $this->sbrunch)->result();
