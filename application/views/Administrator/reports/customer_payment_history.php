                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="payment in payments">
							...
							<td style="text-align:right;">{{ payment.CPayment_po_charge_amount }}</td>
                        </tr>
                    </tbody>
                    <tfoot v-if="paymentType != ''">
                        <tr>
                            ...
                            <td style="text-align:right;">{{ payments.reduce((p, c) => { return p + parseFloat(c.CPayment_po_charge_amount)}, 0).toFixed(2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
