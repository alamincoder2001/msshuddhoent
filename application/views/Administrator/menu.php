...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("addCustomerPO", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>addCustomerPO">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Add Customer PO </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			array_search("customer_po_report", $access) > -1
			...
			<li class="">
				...
				<ul class="submenu">
					<?php if (array_search("customer_po_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>customer_po_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Customer PO Report
							</a>
							<b class="arrow"></b>
