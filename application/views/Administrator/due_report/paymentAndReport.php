                ...
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size: 14px; font-weight: 700;text-align:center;">PO Charge</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <?php if ($type == 'CR') : echo number_format($CPROW->CPayment_amount, 2);
                                else : echo '00.00';
                                endif; ?></td>
                            <td style="text-align:right;">
                                <?php if ($type == 'CR') : echo number_format($CPROW->CPayment_po_charge_amount, 2);
                                else : echo '00.00';
                                endif; ?></td>
                            <td style="text-align:right;">
                                <?php if ($type == 'CP') : echo number_format($CPROW->CPayment_amount, 2);
                                else : echo '00.00';
                                endif; ?></td>
                        </tr>
