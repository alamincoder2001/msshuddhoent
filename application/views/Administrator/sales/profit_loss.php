			...
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Sale Transport Cost (+)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.sale_transport_cost | decimal }}</td>
						</tr>

						<tr>
							<td colspan="4" style="text-align:right;">PO Charge (+)</td>
							<td colspan="2"></td>
							<td style="text-align:right;">{{ otherIncomeExpense.po_charge | decimal }}</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"></td>
							<td style="text-align:right;">
								{{ ((parseFloat(totalProfit) + parseFloat(totalVat) + parseFloat(otherIncome) + parseFloat(this.otherIncomeExpense.sale_transport_cost) + parseFloat(this.otherIncomeExpense.po_charge)) - 
