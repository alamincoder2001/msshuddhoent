        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="addCustomerPO" v-model="access"> Add Customer PO</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accountsReports">
                    <li><input type="checkbox" class="access" value="customer_po_report" v-model="access"> Customer PO Report</li>
