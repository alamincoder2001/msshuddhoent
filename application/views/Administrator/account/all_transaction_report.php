                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        <tr v-for="transaction in transactions">
                            ...
                            <td style="text-align:right;">{{ transaction.In_Amount-transaction.Out_Amount }}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td style="text-align:right;font-weight:bold;">{{ transactions.reduce((p, c) => { return p + parseFloat(c.In_Amount)-parseFloat(c.Out_Amount) }, 0) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
